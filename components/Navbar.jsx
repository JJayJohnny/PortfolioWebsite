...
const Navbar = () => {
    ...
    return (
        <header className={`w-full px-32 py-10 font-medium flex max-md:flex-col max-md:space-y-6 flex-row items-center justify-between shadow fixed z-50 top-0 ${theme === 'dark' ? 'bg-black' : 'bg-white'}`}>
