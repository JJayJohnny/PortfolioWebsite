...
const About = () => {
    return(
        <section id="about" className="my-60">
            ...
            <div className="flex flex-col justify-between space-x-10 md:flex-row md:px-60 px-10 max-md:space-y-10">
                <div className="md:w-3/5 justify-center md:text-justify text-center">
                ...
                <div className="md:w-2/5">
                    <h2 className="md:text-left text-center text-2xl font-bold mb-3">My skills:</h2>
